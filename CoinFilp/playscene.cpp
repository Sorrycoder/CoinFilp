...
PlayScene::PlayScene(int index)
{
    ...
    //actSave->setIcon(QIcon(":/res/save.png"));
    connect(actSave, &QAction::triggered, this, &PlayScene::saveGame);
    connect(actLoad, &QAction::triggered, this, &PlayScene::loadGame);
...
void PlayScene::saveGame()
{
    ...
    // 写入文件
    //QIODevice::Text
    QString fileName = QString("debug/saves/savegame_level_%1.json").arg(this->levalIndex);
    QFile file(fileName);
...
bool PlayScene::loadGame()
{
    ...
    if (file.open(QIODevice::ReadOnly | QIODevice::Text)) {
        ...
        QMessageBox msgBox;
        msgBox.move(QPoint(this->x()+5,this->y()+250));
